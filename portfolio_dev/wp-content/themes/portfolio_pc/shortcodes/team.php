...
function team(){
    ...
    $i = 1;
    $str = '<div class="elementor-row staff content">';
            ...
            <div class ="elementor-column-wrap">
                <div class="elementor-widget-wrap">
                    <div class="image-wrapper">
                        ...
                        <img src="'.$thumbnail.'" alt="'.get_the_title().'"></a>
                    </div>
                    <div class="team-member-info">
                        ...
                        <div>
                            ...
                            .do_shortcode('[acf field="email_address"]').'</a>
                        </div>
                        <div>
                            <a href="tel:'.do_shortcode('[acf field="phone_number"]').'" title="Call '.get_the_title().'">'
                            .do_shortcode('[acf field="phone_number"]').'</a>
                        </div>
                    </div>
                </div>
            </div>
