...
add_filter('manage_practice_area_posts_columns', 'practice_area_columns');

function practice_area_columns($columns){
    $columns = array(
        'cb' => 'cb',
        'title' => 'Title',
        'order' => 'Order',
...
add_filter('manage_edit-practice_area_sortable_columns','practice_area_sortable_columns');

function practice_area_sortable_columns($columns){
    $columns['order']='order';
    return $columns;
}

add_action('manage_practice_area_posts_custom_column','practice_area_show_columns');

function practice_area_show_columns($column_name){
    global $post;
